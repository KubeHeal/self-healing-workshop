...
All Python examples in this section are available as downloadable, runnable scripts:

[source,bash,role=execute]
----
# Download the LightspeedClient library
...
Or browse all examples in the repository: https://github.com/KubeHeal/self-healing-workshop/tree/main/examples/python[GitHub Examples Directory^]
...
=== Download Integration Pattern Scripts

All integration patterns are available as ready-to-run scripts:

[source,bash,role=execute]
----
# Download all integration patterns
curl -O https://raw.githubusercontent.com/KubeHeal/self-healing-workshop/main/examples/python/pattern_alert_response.py
curl -O https://raw.githubusercontent.com/KubeHeal/self-healing-workshop/main/examples/python/pattern_batch_analysis.py
curl -O https://raw.githubusercontent.com/KubeHeal/self-healing-workshop/main/examples/python/pattern_capacity_planning.py

# These patterns require the LightspeedClient library
curl -O https://raw.githubusercontent.com/KubeHeal/self-healing-workshop/main/examples/python/lightspeed_client.py
...
python pattern_capacity_planning.py --output report.json
----
...
The easiest way to get started is to download the ready-to-use monitoring script:

[source,bash,role=execute]
----
# Download the monitoring script
curl -O https://raw.githubusercontent.com/KubeHeal/self-healing-workshop/main/examples/python/monitor_cluster.py

# Install dependencies if needed
pip install requests

# Run the monitor (adjust URL and namespace as needed)
...
======================================================================
Server URL: http://ols-server:8000
Namespace: self-healing-platform
