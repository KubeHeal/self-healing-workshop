...
[NOTE]
====
**Development Status:** This workshop is actively in development. The deployment strategy is evolving:
...
- ✅ Self-healing platform deployed in `self-healing-platform` namespace
- ✅ ArgoCD managing GitOps deployments
- ✅ Coordination engine and MCP server running
- ✅ KServe ML models (anomaly-detector, predictive-analytics)
- ✅ Jupyter workbench for notebook development (accessible via port-forward)
- ✅ OpenShift Lightspeed integration (if configured)

==== Complete Instructions

For detailed step-by-step instructions, troubleshooting, and advanced configuration options, see:

**📖 https://github.com/KubeHeal/openshift-aiops-platform#option-1-fork-and-deploy-recommended-for-development[OpenShift AI Ops Platform - Fork and Deploy Guide]**
...
* ✅ Validated Patterns Operator (GitOps deployment framework)
* ✅ Self-Healing Platform components (coordination engine, MCP server)
* ✅ KServe ML models for anomaly detection
* ✅ OpenShift Lightspeed operator (optional AI assistant)
* ✅ Jupyter workbench with all workshop notebooks
* ✅ ArgoCD application for continuous GitOps sync
